! function(e, t) {
    ...
    e.setupNavigation = function() {
        ...
        function a() {
            ...
            function a(e) {
                function a() {
                    ...
                    r.toggleClass("open"), e.attr("aria-expanded", "true" === t ? "false" : "true")
                }
                var r = t(this);
            ...
            var r = t("nav.navbar .dropdown");
            r.on("show.bs.dropdown", e), r.on("hide.bs.dropdown", a)
        }
        e(), a()
    }, e.updateCopyrightYear = function() {
        t("#year").html((new Date).getFullYear())
    }, e.search = {}, e.search.focus = function() {
        t(".search-page .form-search-input").focus().each(function() {
        ...
        function a() {
            var e = t(".article-page .breadcrumb");
            if (e.length > 0)
                for (var a = ["Core Java Tutorial", "Java Servlet", "SEO", "Facebook", "Spring Framework", "Java 8 Tutorial"], n = e.find("li.active"), r = 0; r < a.length; r++) {
                    var o = n.find('a[data-tag="' + a[r] + '"]');
                    if (o.length > 0) return n.before(t("<li typeof=\"v:Breadcrumb\"></li>").append(o.clone().removeClass())), void o.remove()
                }
        }
        a()
        ...
        function a() {
            var e = [];
            return t('a[rel="tag"]').each(function() {
                var a = t.trim(t(this).text().replace(/\n/g, "")); - 1 === t.inArray(a, e) && (e[e.length] = a)
            }), e
        }
        ...
        function r(e) {
            for (var t = 0; t < e.link.length; t++)
                if ("alternate" === e.link[t].rel) return e.link[t].href;
            return ""
        }
        ...
        function s(a) {
            ...
            if (u >= c.length) {
                d = i(d, "score"), d = d.splice(0, e.maxPosts);
                var s = t(".article-related");
                s.append("<ul></ul>");
        ...
        function l() {
            if (t(".article-related").length > 0) {
                c = a();
                for (var n = 0; n < c.length; n++) t.ajax({
        ...
        function e() {
            ...
            if (e.length > 0) {
                var a = [{
                    ...
                    r = t.grep(a, function(e, t) {
                        return e.name === n
                    })[0];
                r && (t(".article-meta .media a").attr("href", r.social), t(".article-meta .media-left img").attr("src", r.avatar))
            }
        }
        e()
        ...
        function e() {
            window.ga = window.ga || function() {
                ...
                cookieDomain: "broculos.net",
                siteSpeedSampleRate: 100
            }), window.ga("require", "linkid", "linkid.js"), window.ga("send", "pageview"), t.getScript("http://www.google-analytics.com/analytics.js"), r()
        }
        ...
        function n(e) {
            ...
            return t.length <= 0 && a(e), t.length <= 0 && (t = e.attr("href")), t
        }
        ...
        function r() {
            for (var e = [{
                    ...
                    label: ""
                }], a = 0; a < e.length; a++) t(e[a].selector).attr("data-category", e[a].category), t(e[a].selector).attr("data-label", e[a].label), t(e[a].selector).on("click", function() {
                window.ga("send", "event", t(this).attr("data-category"), n(t(this)))
            })
        }
        e()
        ...
        function e() {
            var e = t("#notfound"),
                a = document.URL.substring(document.URL.lastIndexOf("/") + 1);
            a = decodeURIComponent((a + "").replace(/\+/g, "%20")), a.lastIndexOf(".") > 0 && (a = a.substring(0, a.lastIndexOf("."))), a = a.replace(/[\-\_\+]+/g, " ");
